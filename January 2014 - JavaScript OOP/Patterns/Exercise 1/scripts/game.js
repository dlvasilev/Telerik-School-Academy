var games = (function () {
	...
	function animationFrame() {
		...
		if (snakePosition.x < dimensions.minWidth-5) {
			newX = dimensions.maxWidth;
			toChangePosition = true;
		} else if (dimensions.maxWidth - 5 < snakePosition.x) {
			newX = dimensions.minWidth;
			toChangePosition = true;
		}
		if (snakePosition.y < dimensions.minHeight - 5) {
			newY = dimensions.maxHeight;
			toChangePosition = true;
		}
		if (dimensions.maxHeight - 5 < snakePosition.y) {
